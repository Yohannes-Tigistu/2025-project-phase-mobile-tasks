...
import 'package:ecommerce_app/features/Products/data/datasources/products_local_data_source.dart';
...
void main() {
  ...
  group('createProduct', () {
    ...
    group('when device is online', () {
      test(
        'should return Confirmation when product is created successfully',
        () async {
          // Arrange
          ...
          when(remoteDataSource.createProduct(tProduct)).thenAnswer(
            (_) async => Confirmation('Product created successfully'),
          );
          // Act
      ...
      test('should return ServerFailure when product creation fails', () async {
        ...
        when(
          remoteDataSource.createProduct(tProduct),
        ).thenThrow(Exception('Server Failure'));
        // Act
        final result = await repository.createProduct(tProduct);
        // Assert
    ...
    group('when device is offline', () {
      ...
      test(
        'should return CacheFailure when trying to create product while offline',
        () async {
          // Arrange
          final tProduct = ProductModel(
            id: 1,
    ...
    group('deleteProduct', () {
      ...
      group('when device is online', () {
        test(
          ...
          () async {
            // Arrange
            when(remoteDataSource.deleteProduct(tId)).thenAnswer(
              (_) async => Confirmation('Product deleted successfully'),
            );
            when(localDataSource.deleteProduct(tId)).thenAnswer(
              (_) async => Confirmation('Product deleted successfully'),
            );
            // Act
        ...
        test(
          'should return ServerFailure when remote deletion fails',
          () async {
            // Arrange
            when(
              remoteDataSource.deleteProduct(tId),
            ).thenThrow(Exception('Server Failure'));
            // Act
            final result = await repository.deleteProduct(tId);
            // Assert
    ...
    group('getProductById', () {
      ...
      group('when device is online', () {
        ...
        test(
          ...
          () async {
            // Arrange
            when(
              remoteDataSource.getProductById(tId),
      ...
      group('when device is offline', () {
        ...
        test('should return cached product when device is offline', () async {
          // Arrange
          when(
            localDataSource.getProductById(tId),
          ).thenAnswer((_) async => tProductModel);
          // Act
          final result = await repository.getProductById(tId);
          // Assert
        ...
        test(
          'should return CacheFailure when there is no cached product',
          () async {
            // Arrange
            when(
              localDataSource.getProductById(tId),
    ...
    group('updateProduct', () {
      ...
      group('when device is online', () {
        ...
        test(
          ...
          () async {
            // Arrange
            when(remoteDataSource.updateProduct(tProductModel)).thenAnswer(
              (_) async => Confirmation('Product updated successfully'),
            );
            when(localDataSource.updateProduct(tProductModel)).thenAnswer(
              (_) async => Confirmation('Product updated successfully'),
            );
            // Act
        ...
        test('should return ServerFailure when remote update fails', () async {
          // Arrange
          when(
            remoteDataSource.updateProduct(tProductModel),
          ).thenThrow(Exception('Server Failure'));
          // Act
          final result = await repository.updateProduct(tProductModel);
          // Assert
